# cifar10-autoresearch

This is an autonomous research experiment managed by autoresearchstudio.

Autonomous optimization of a CNN for CIFAR-10 image classification.
...
Keep the model small enough to train on CPU in the time budget. CIFAR-10 is harder than MNIST — 10 classes of 32x32 color images. A GPU is not required for this example.
