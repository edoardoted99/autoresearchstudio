"""
One-time data preparation for Fashion-MNIST autoresearch experiments.
Downloads Fashion-MNIST and provides data loading utilities.
...
def download_fashion_mnist():
    ...
    for name, filename in FILES.items():
        ...
        if filepath.exists():
            ...
            continue
        url = f"{FASHION_MNIST_URL}/{filename}"
...
def load_data():
    """Load Fashion-MNIST train and test data as tensors."""
